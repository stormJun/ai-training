...
- `06_prompt_templates.md` - `13b_deerflow_prompt_layering_demo.py`
  - Prompt 模板、模板工程化、自定义模板、DeerFlow 设计案例、纯 Python layering demo 和示例配置
- `14_output_parsing_and_chains.md` - `18_chain_and_runnable_guide.py`
  - 输出解析器、基础 Chain、Runnable 和 LCEL 示例
- `18a_runnable_config_guide.md`
  - `RunnableConfig` 的使用说明与源码梳理
- `18b_deerflow_runnable_design.md`
  - DeerFlow 中 `Runnable` 的工程落地与运行链梳理
...
uv run python 13b_deerflow_prompt_layering_demo.py
