...
```
```python
!langgraph new "D:\AI工程化训练营\workspace\21_langgraph_workflows\app" --template new-langgraph-project-python
```
**Output:**
...
✅ Downloaded and extracted repository to D:\AI工程化训练营\workspace\21_langgraph_workflows\app
🎉 New project created at D:\AI工程化训练营\workspace\21_langgraph_workflows\app
```
```python
