...
- 当前目录下的 `.env`
- `27_multi_agent_frameworks/27_autogen_two_agent_chat/.env`
...
如果你先把这套机制看懂，再去读同目录的 [p13-Langgraph-MAS.py](/Users/songxijun/workspace/otherProject/ai-training/06_langgraph_basics/05_multi_agent/tutorials/01_langgraph_multi_agent_basics/p13-Langgraph-MAS.py)，代码会容易理解很多。  
