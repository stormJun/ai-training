...
## 目录定位
`25_vllm_wrapper_demo/vllm_wrapper_demo` 是 02_workflows 中用于演示 vLLM 接入与参数工程化管理的模块。
...
## 运行方式
在 `02_workflows` 目录下建议使用项目虚拟环境：

```bash
cd /Users/songxijun/workspace/otherProject/ai-training/02_workflows
python -m venv .venv
