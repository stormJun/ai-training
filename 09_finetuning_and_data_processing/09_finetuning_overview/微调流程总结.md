...
```bash
# 转换训练集（指令格式）
python3 ../10_massive_dataset_processing/convert_massive_to_training_format.py \
  --input ../10_massive_dataset_processing/amazon_massive_intent_zh_cn/train.jsonl \
  --output ../10_massive_dataset_processing/amazon_massive_intent_zh_cn/train_converted.jsonl \
  --format instruction \
  --preview
...
python3 ../10_massive_dataset_processing/convert_massive_to_training_format.py \
  --input ../10_massive_dataset_processing/amazon_massive_intent_zh_cn/train.jsonl \
  --output ../10_massive_dataset_processing/amazon_massive_intent_zh_cn/train_chat.jsonl \
  --format chat \
  --preview
```
