...
本目录汇集了 “Python 高性能并发” 相关的全部示例，涵盖 **协程语法、事件循环深度解析、Future/Task 调度、多线程/多进程混合、网络 IO 工具链、LangChain/LangGraph 异步实践、性能剖析与压测、GPU/向量检索** 等主题。脚本既可以在课堂上逐段讲解，也可作为你在真实项目中排查性能瓶颈、设计高吞吐架构的参考。
...
```bash
# 进入项目根目录
cd 09_python_async_and_performance/foundations
