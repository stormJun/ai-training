...
```bash
cd 53_model_extensions/54_multimodal_clip_search/multimodal_clip_search/p25-CLIP
...
**基于项目**: 53_model_extensions/54_multimodal_clip_search/multimodal_clip_search/p25-CLIP
