...
```bash
cd 17_model_extensions/02_multimodal_clip_search/multimodal_clip_search/p25-CLIP
...
**基于项目**: 17_model_extensions/02_multimodal_clip_search/multimodal_clip_search/p25-CLIP
