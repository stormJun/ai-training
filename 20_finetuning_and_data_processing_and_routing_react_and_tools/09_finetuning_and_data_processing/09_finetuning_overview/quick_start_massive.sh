...
DATA_DIR="../10_massive_dataset_processing/amazon_massive_intent_zh_cn"
CONVERTER="../10_massive_dataset_processing/convert_massive_to_training_format.py"
SERVER_SCRIPT="../12_local_finetuning_platform/local_ft/server.py"
