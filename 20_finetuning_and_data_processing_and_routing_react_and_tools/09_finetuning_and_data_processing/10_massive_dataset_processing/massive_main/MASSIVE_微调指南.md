...
`12_local_finetuning_platform` 微调平台需要以下格式：
...
```bash
cd 09_finetuning_and_data_processing/10_massive_dataset_processing
...
```bash
cd 09_finetuning_and_data_processing/10_massive_dataset_processing
python ../12_local_finetuning_platform/local_ft/server.py
```
