...
- 源码参考：`13_rag_and_retrieval/17_qanything_case_study/qanything_case_study/qanything_kernel/core/local_doc_qa.py` 中约 `523-546` 行（`saved_docs` 与 `relative_difference` 逻辑）。
...
> **详细内容请参考**: [`Ragas工程实践指南.md`](../../14_ragas_retrieval_evaluation/docs/Ragas工程实践指南.md)
...
根据 `13_rag_and_retrieval/17_qanything_case_study/qanything_case_study/docs/混合检索实现原理详解.md`,混合检索结合了向量检索和全文检索的优势:
...
4. 本仓库文档:
   - `13_rag_and_retrieval/13_llamaindex_retrieval_basics/docs/llamaindex学习文档.md`
   - `13_rag_and_retrieval/14_ragas_retrieval_evaluation/docs/Ragas工程实践指南.md`
   - `13_rag_and_retrieval/17_qanything_case_study/qanything_case_study/docs/混合检索实现原理详解.md`
