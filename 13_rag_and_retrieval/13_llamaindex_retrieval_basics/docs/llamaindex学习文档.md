...
本文对应目录：`13_rag_and_retrieval/13_llamaindex_retrieval_basics/code/llamaindex`，用于帮助你快速理解每个示例文件“在做什么、能学到什么”。
...
1. 先在 `13_rag_and_retrieval/13_llamaindex_retrieval_basics/code/.env` 配置 `DASHSCOPE_API_KEY`
2. 运行脚本时建议从 `13_rag_and_retrieval/13_llamaindex_retrieval_basics` 根目录启动：
