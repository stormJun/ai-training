...
- 需在 `03_rag_and_retrieval/llamaindex_and_ragas/code/ragas` 目录下运行（依赖本地 `ragas_chinese_prompts.py`）
"""
...
# 适配到中文 Prompt（定义见 `03_rag_and_retrieval/llamaindex_and_ragas/code/ragas/ragas_chinese_prompts.py`）
_apply_prompt(
