...
- 源码参考：`04_rag_and_retrieval/06_qanything_case_study/qanything_case_study/qanything_kernel/core/local_doc_qa.py` 中约 `523-546` 行（`saved_docs` 与 `relative_difference` 逻辑）。
...
> **详细内容请参考**: [`Ragas工程实践指南.md`](../../03_ragas_retrieval_evaluation/docs/Ragas工程实践指南.md)
...
根据 `04_rag_and_retrieval/06_qanything_case_study/qanything_case_study/docs/混合检索实现原理详解.md`,混合检索结合了向量检索和全文检索的优势:
...
├── 02_llamaindex_retrieval_basics/
│   ├── docs/                              # LlamaIndex / RAG 文档
│   │   ├── RAG系统学习指南.md             # 本文档 (总览)
│   │   └── llamaindex学习文档.md          # LlamaIndex 详细指南
│   └── code/
│       ├── llamaindex/                    # LlamaIndex 示例
│       └── ragas/                         # RAGAS 评估示例
├── 03_ragas_retrieval_evaluation/
│   └── docs/
│       └── Ragas工程实践指南.md           # RAGAS 评估指南
└── 06_qanything_case_study/
    └── qanything_case_study/
        └── docs/
            ├── 混合检索实现原理详解.md
            └── 重排序两层过滤策略详解.md
```
...
4. 本仓库文档:
   - `04_rag_and_retrieval/02_llamaindex_retrieval_basics/docs/llamaindex学习文档.md`
   - `04_rag_and_retrieval/03_ragas_retrieval_evaluation/docs/Ragas工程实践指南.md`
   - `04_rag_and_retrieval/06_qanything_case_study/qanything_case_study/docs/混合检索实现原理详解.md`
