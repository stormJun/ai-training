// Package main: Pregel 引擎 + channel 抽象(增量 6)。
//
...
//
//	Message  ── 纯数据
//	Vertex   ── Compute(单值,已merge) + StreamCompute(流,已merge)
//	Engine   ── Run/StreamRun 通过 channel 调度
//
...
func sortedChanKeys(cm *channelManager) []string {
