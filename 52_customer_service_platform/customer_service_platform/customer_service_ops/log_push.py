...
def default_config():
    return {
        "input_file": "customer_service_ops/logs/requests.log",
        "state_file": "customer_service_ops/state/log_push_state.json",
...
def build_logger():
    ...
    ensure_dir("customer_service_ops/logs")
    fh = logging.FileHandler(abs_path("customer_service_ops/logs/log_push_service.log"), encoding="utf-8")
...
def main():
    ...
    parser.add_argument("--config", default="customer_service_ops/log_push_config.json")
