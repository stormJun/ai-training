...
### 1.1 输入数据
- **文件**: `06_finetuning_and_data_processing_and_routing_react_and_tools/01_finetuning_and_data_processing/02_massive_dataset_processing/chinese_data/zh-CN.jsonl`
...
if __name__ == "__main__":
    process_massive_data(
        input_file="06_finetuning_and_data_processing_and_routing_react_and_tools/01_finetuning_and_data_processing/02_massive_dataset_processing/chinese_data/zh-CN.jsonl",
        output_dir="06_finetuning_and_data_processing_and_routing_react_and_tools/01_finetuning_and_data_processing/02_massive_dataset_processing/chinese_data/processed_instruction",
    ...
    process_massive_data(
        input_file="06_finetuning_and_data_processing_and_routing_react_and_tools/01_finetuning_and_data_processing/02_massive_dataset_processing/chinese_data/zh-CN.jsonl",
        output_dir="06_finetuning_and_data_processing_and_routing_react_and_tools/01_finetuning_and_data_processing/02_massive_dataset_processing/chinese_data/processed_chat",
        format_type="chat",
        enable_filter=True
    )
```
...
```
06_finetuning_and_data_processing_and_routing_react_and_tools/01_finetuning_and_data_processing/02_massive_dataset_processing/chinese_data/
├── zh-CN.jsonl                           # 原始数据
