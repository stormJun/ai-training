...
### 提交要求
在以下目录完成编码作业：
- [assignments/multi_agent_homework/multi-agent](./multi-agent)
...
```
https://github.com/your-username/ai-engineer-training/tree/main/assignments/multi_agent_homework
```