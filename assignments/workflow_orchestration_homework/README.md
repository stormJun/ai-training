...
- [assignments/workflow_orchestration_homework/smart_customer_service](./smart_customer_service)
...
```
https://github.com/your-username/ai-engineer-training/tree/main/assignments/workflow_orchestration_homework
```