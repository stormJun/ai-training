...
def main() -> None:
    ...
    # 这样脚本迁移到 code/ragas 后，仍可复用 week03/code/.env。
    ...
    if not api_key:
        raise EnvironmentError(
            "未检测到 DASHSCOPE_API_KEY。请先在 week03/code/.env 中配置后再运行。"
        )
