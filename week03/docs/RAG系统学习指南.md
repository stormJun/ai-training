...
> 本文档是 Week03 RAG 系统学习的总览性指南,整合了 LlamaIndex、RAGAS 评估、混合检索等核心内容。
...
- 源码参考：`week03-qanything/qanything_kernel/core/local_doc_qa.py` 中约 `523-546` 行（`saved_docs` 与 `relative_difference` 逻辑）。
...
根据 `week03-qanything/docs/混合检索实现原理详解.md`,混合检索结合了向量检索和全文检索的优势:
...
│
└── week03-qanything/                  # QAnything 实战项目
    └── docs/
        ├── 混合检索实现原理详解.md
        └── 重排序两层过滤策略详解.md
```
...
4. 本仓库文档:
   - `week03/docs/llamaindex学习文档.md`
   - `week03/docs/ragas工程实践指南.md`
   - `week03-qanything/docs/混合检索实现原理详解.md`
