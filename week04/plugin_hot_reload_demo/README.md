...
```bash
cd /Users/songxijun/workspace/otherProject/ai-training/week04/plugin_hot_reload_demo
python3 -m venv .venv
...
1. 打开 [greeting.py](/Users/songxijun/workspace/otherProject/ai-training/week04/plugin_hot_reload_demo/src/plugin_hot_reload_demo/plugins/greeting.py)
