# week04-langgraph-demo 源码解析：Host/Subagent 协作与状态流转

这篇文档回答的不是“怎么运行 demo”，而是另一个更适合进阶读者的问题：

> `week04-langgraph-demo` 是怎样把 `HostAgent`、多个 `Subagent`、本地数据仓库，以及 `direct / remote` 两种执行模式，编排成一个完整的 LangGraph 演示项目的？

如果你已经会写一个简单的 `StateGraph`，但还不清楚一个小型多代理 demo 应该如何拆职责、如何组织状态、如何统一本地调用与远程调用，这篇文档就是给你的。

## 1. 先看整体：这个 demo 想解决什么问题

`week04-langgraph-demo` 不是一个“单图完成所有事情”的例子，而是一个刻意做了职责拆分的 `Master / Subagent` 演示：
...
- [host_agent.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/host_agent.py)
- [stock_agent.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/stock_agent.py)
- [analysis_agent.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/analysis_agent.py)
- [store.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/store.py)
- [models.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/models.py)
- [stock_service.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/apps/stock_service.py)
- [analysis_service.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/apps/analysis_service.py)
...
`HostState` 定义在 [host_agent.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/host_agent.py) 中，字段包括：
...
`StockAgentState` 定义在 [stock_agent.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/stock_agent.py) 中：
...
`AnalysisState` 定义在 [analysis_agent.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/analysis_agent.py) 中：
...
2. `lookup_stock`
   调用 [store.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/store.py) 的 `get_stock_by_identifier`，从静态仓库取回 `StockRecord`。
...
[models.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/models.py) 定义了三个核心模型：
...
[store.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/store.py) 做了三件事：
...
[stock_service.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/apps/stock_service.py) 和 [analysis_service.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/apps/analysis_service.py) 都很薄：
...
[run_all.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/src/week04_langgraph_demo/run_all.py) 负责：
...
[test_demo.py](/Users/songxijun/workspace/otherProject/ai-training/week04-langgraph-demo/tests/test_demo.py) 目前验证了三件事：
...
`week04-langgraph-demo` 的价值，不在于它做了多复杂的股票分析，而在于它用一个足够小、足够透明的项目，把多代理系统里最关键的几个工程问题拆给你看：
