...
## 目录定位
`week04/vllm_wrapper_demo` 是 week04 中用于演示 vLLM 接入与参数工程化管理的模块。
...
## 运行方式
在 `week04` 目录下建议使用项目虚拟环境：

```bash
cd /Users/songxijun/workspace/otherProject/ai-training/week04
python -m venv .venv
