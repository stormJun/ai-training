...
```text
02_langgraph_basics/04_demo_project/langgraph_demo_project
├── src/langgraph_demo
│   ├── apps/
│   │   ├── stock_service.py
│   │   └── analysis_service.py
...
```bash
cd /Users/songxijun/workspace/otherProject/ai-training/02_langgraph_basics/04_demo_project/langgraph_demo_project
python3 -m venv .venv
...
可参考 [.env.example](/Users/songxijun/workspace/otherProject/ai-training/02_langgraph_basics/04_demo_project/langgraph_demo_project/.env.example)：
