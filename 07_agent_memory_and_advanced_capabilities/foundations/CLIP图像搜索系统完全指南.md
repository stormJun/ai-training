...
```bash
cd 07_agent_memory_and_advanced_capabilities/foundations/standalone_projects/p25-CLIP
...
**基于项目**: 07_agent_memory_and_advanced_capabilities/foundations/standalone_projects/p25-CLIP
