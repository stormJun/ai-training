...
- RPA 与 AI 工作流集成：
  - `04_workflow_orchestration/rpa_and_ai_workflow/`
- 小模型优化：
  - `11_extension_topics/slm_optimization/`
- CLIP 图像搜索：
  - `11_extension_topics/multimodal_clip_search/`
- 强化学习：
  - `11_extension_topics/reinforcement_learning/`
- 第三方全栈示例：
